      ...
      >
        ...
        <ThemedCard style={styles.sectionCard}>
          <ThemedView variant="transparent" style={styles.sectionHeader}>
            ...
            <ThemedView variant="transparent" style={styles.sectionHeaderText}>
              <ThemedText size="lg" weight="semibold" style={styles.sectionTitle}>
                {t('agent.settings.orientationTitle')}
              </ThemedText>
              <ThemedText variant="secondary" size="sm" style={styles.sectionSubtitle}>
                {t('agent.settings.orientationSubtitle')}
              </ThemedText>
            </ThemedView>
          </ThemedView>
          ...
          <View style={styles.optionsContainer}>
            <PressableButton
              ...
              accessibilityLabel={t('agent.settings.orientationPortrait')}
            >
              <ThemedText
                size="sm"
                weight="semibold"
              ...
              >
                {t('agent.settings.orientationPortrait')}
              </ThemedText>
            </PressableButton>
            ...
            <PressableButton
              ...
              accessibilityLabel={t('agent.settings.orientationLandscape')}
            >
              <ThemedText
                size="sm"
                weight="semibold"
              ...
              >
                {t('agent.settings.orientationLandscape')}
              </ThemedText>
            </PressableButton>
            ...
            <PressableButton
              ...
              accessibilityLabel={t('agent.settings.orientationAuto')}
            >
              <ThemedText
                size="sm"
                weight="semibold"
              ...
              >
                {t('agent.settings.orientationAuto')}
              </ThemedText>
            </PressableButton>
          </View>
        </ThemedCard>
